...
class ForumController extends \application\protect\controllers\CommonController
{
	...
	public function getRoleSelect($name, $selectedValue)
	{
		...
		{
			$roleList = self::$roleList = \application\protect\models\RoleModel::model()->field('id, name, level')->order('level ASC')->select();
		}
		else 
		{
