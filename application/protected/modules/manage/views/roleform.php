...
<form class="form-horizontal" action="<?php echo $this->createUrl('manage/role/roleadd')?>" method="post">
  ...
  <div class="form-group <?php echo $model->getError('bonus_limit') != NULL ? "has-error" : ""?>">
    <label for="bonus_limit" class="col-sm-2 control-label">魔力下限</label>
    <div class="col-sm-10">
      <input type="text" class="form-control" id="bonus_limit" name="bonus_limit" placeholder="">
  ...
  <div class="form-group <?php echo $model->getError('downloaded_limit') != NULL ? "has-error" : ""?>">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="downloaded_limit" name="downloaded_limit" placeholder="">
  ...
  <div class="form-group <?php echo $model->getError('uploaded_limit') != NULL ? "has-error" : ""?>">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="uploaded_limit" name="uploaded_limit" placeholder="">
  ...
  <div class="form-group <?php echo $model->getError('ratio_limit') != NULL ? "has-error" : ""?>">
    ...
    <div class="col-sm-10">
      <input type="text" class="form-control" id="ratio_limit" name="ratio_limit" placeholder="">
  ...
  <div class="form-group <?php echo $model->getError('register_time_limit') != NULL ? "has-error" : ""?>">
    ...
    <div class="col-sm-8">
      <input type="text" class="form-control" id="register_time_limit" name="register_time_limit" placeholder="">
