<div class="row">
      <form class="form-horizontal" role="form" id="upload-form" method="post" action="upload.html" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" id="inputPassword3" placeholder="标题" name="main_title">
          </div>
        </div>
        <div class="form-group">
          <label for="inputPassword3" class="col-sm-2 control-label">副标题</label>
          <div class="col-sm-10">
            <input type="text" class="form-control" id="inputPassword3" placeholder="副标题" name="slave_title">
          </div>
        </div>
        <div class="form-group">
